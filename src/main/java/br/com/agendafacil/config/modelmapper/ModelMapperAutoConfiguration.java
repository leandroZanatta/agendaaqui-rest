...
/**
 * The {@code ModelMapper} auto configuration. It requires that the model mapper
 * will be on classpath and afterwards it's going to register
 * {@link ModelMapperFactoryBean} within the application context.
 *
