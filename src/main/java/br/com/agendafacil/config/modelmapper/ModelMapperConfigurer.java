...
/**
 * Allows to set specific behaviour of the {@link ModelMapper} instance. The
 * concrete implementation of this interface needs to be registered within the
 * application context in order to be processed.
 *
 * <pre>
